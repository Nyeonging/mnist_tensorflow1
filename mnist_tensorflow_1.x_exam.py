...
import keras
import tensorflow.compat.v1 as tf #수정/추가
import pandas as pd #수정/추가


tf.disable_eager_execution() #수정/추가
...
with tf.Session() as sess:
    ...
    print()
    print("Tensorflow:",tf.__version__) #형식 수정
